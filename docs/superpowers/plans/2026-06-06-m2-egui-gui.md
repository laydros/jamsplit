...
**Read first:** `docs/superpowers/specs/2026-06-05-jam-wav-splitter-design.md` — especially the "Core API as implemented in M1" block and the "GUI (jamsplit-gui)" section. This plan implements that section exactly.
