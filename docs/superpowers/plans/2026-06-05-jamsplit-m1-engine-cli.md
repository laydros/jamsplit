...
**Source of truth:** `docs/superpowers/specs/2026-06-05-jamsplit-design.md` (design, binding) and `docs/spec-v1.md` (requirements). If this plan and the design doc conflict, the design doc wins — stop and flag it.
...
Map each criterion from `docs/spec-v1.md` to its evidence:
